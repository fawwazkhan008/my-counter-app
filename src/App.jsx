...
//         className="bg-white dark:bg-gray-800 dark:text-white text-black p-6 sm:p-8 rounded-xl shadow-lg w-full max-w-md text-center"
//       >
...
//             className="text-xs sm:text-sm bg-indigo-500 hover:bg-indigo-600 text-white px-3 py-1 rounded"
//           >
...
//           <h2 className="font-semibold mb-2 text-lg underline">📝 History</h2>
//           {history.length === 0 ? (
